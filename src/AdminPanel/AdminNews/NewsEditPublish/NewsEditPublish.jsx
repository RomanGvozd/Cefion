...
function NewsEditPublish({newsID}) {
    ...
    const { DownloadCover, InputRU, InputEN, Review, Draft, Save, AddHashtag, textareaRU, textareaEN} = content[language];
    ...
    const handleEdit = () => {
        dispatch(editItemPublish(newsID, titleValueRU, titleValueEN, descriptionValueRU, descriptionValueEN, selected, tags))
    }
